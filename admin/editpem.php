    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>Admin</p>
              <p class="designation">Perpustakaan</p>
            </div>
          </div>
          <!-- Sidebar Menu-->
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i> Transaksi Peminjaman</h1>
            <p>PERPUSTAKAAN</p>
          </div>
          <div>
            <ul class="breadcrumb">
		...
		<div class="col-md-12">
            <div class="card">
              ...
              <table class="table">
				...
				$strsql = "SELECT * FROM PINJAM WHERE ID_PINJAM='".$_GET["id"]."'";
				$parse = oci_parse($conn, $strsql);
				oci_execute($parse, OCI_DEFAULT);
				$objResult = oci_fetch_array($parse); 
				?>
				<table>
					<form action='updatepem.php?buku=<?=$_GET["id_pinjam"];?>' method='GET'>
					<tr> <td>Id Peminjaman</td>
							 <td>:</td>
							<td><input type="text"  name='id' value="<?=$objResult["ID_PINJAM"];?>"></td>
					<tr> <td>Id Buku</td>
							 <td>:</td>
							<td><input type="text"  name='id_buku' value="<?=$objResult["ID_BUKU"];?>"></td>
					<tr> <td>Nama</td>
							 <td>:</td>
							<td><input type="text"  name='nama' value="<?=$objResult["NAMA"];?>"></td>
					<tr> <td>Judul</td>
						 <td>:</td>
						 <td><input type='text' name='judul' value="<?=$objResult["JUDUL"];?>"><td>
					</tr>
					<tr> <td>Tanggal Pinjam</td>
						 <td>:</td>
						 <td><input type='text' name='tgl_pinjam' value="<?=$objResult["TGL_PINJAM"];?>"><td>
					</tr>
					<tr> <td>Tanggal Kembali</td>
						<td>:</td>
						<td><input type='text' name='tgl_pengembalian' value="<?=$objResult["TGL_PENGEMBALIAN"];?>"><td>
					</tr>
