    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-th-list"></i> Anggota Perpustakaan</h1>
            <p>Perpustakaan PENS</p>
          </div>
          <div>
            <ul class="breadcrumb">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li>Anggota Pepustakaan</li>
              <li class="active"><a href="#">Update Anggota</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
		<div class="col-md-12">
            <div class="card">
              ...
              <table class="table">
				...
				$strsql = "SELECT * FROM PENJAGA_PERPUS WHERE ID_PENJAGA='".$_GET["id"]."'";
				$parse = oci_parse($conn, $strsql);
				oci_execute($parse, OCI_DEFAULT);
				$objResult = oci_fetch_array($parse); 
				?>
				<table>
				<form action='updateanggota.php?penjaga=<?=$_GET["id_penjaga"];?>' method='GET'>
					
					<tr> <td>Id Anggota</td>
							 <td>:</td>
							 <td><input type="text"  name="id" value="<?=$objResult["ID_PENJAGA"];?>"></td>
					<tr> <td>Nama</td>
						  <td>:</td>
							<td><input type="text"  name="nama" value="<?=$objResult["NAMA"];?>"></td>
					</tr>
					<tr> <td>Alamat</td>
						 <td>:</td>
						  <td><input type='text' name='alamat' value="<?=$objResult["ALAMAT"];?>"><td>
					</tr>
					<tr> <td>Nomor</td>
						 <td>:</td>
						 <td><input type="text"  name="nomor" value="<?=$objResult["NOMOR"];?>"></td>
					</tr>
					<tr> <td>Username</td>
						 <td>:</td>
						 <td><input type="text"  name="username" value="<?=$objResult["USERNAME"];?>"></td>
					</tr>
					<tr> <td>Password</td>
						 <td>:</td>
						<td><input type="text"  name="password" value="<?=$objResult["PASSWORD"];?>"></td>
					</tr>
