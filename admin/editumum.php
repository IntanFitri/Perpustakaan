		...
		<div class="col-md-12">
            <div class="card">
              ...
              <table class="table">
				...
				$strsql = "SELECT * FROM BUKU WHERE ID_BUKU='".$_GET["id_buku"]."'";
				...
				<table>
					...
					<tr> <td>Pengarang</td>
						 <td>:</td>
						 <td><input type='text' name='pengarang' value="<?=$objResult["PENGARANG"];?>"><td>
					</tr>
					<tr> <td>Tahun Terbit</td>
						<td>:</td>
						<td><input type='text' name='tahun_terbit' value="<?=$objResult["TAHUN_TERBIT"];?>"><td>
					</tr>
					<tr> <td>Jenis Buku</td>
						 <td>:</td>
						 <td><input type='text' name='jenis_buku' value="<?=$objResult["JENIS_BUKU"];?>"><td>
					</tr>
					</tr>
					<tr> <td>Status</td>
						 <td>:</td>
						 <td><input type='text' name='status' value="<?=$objResult["STATUS"];?>"><td>
					</tr>
					<tr> <td>Jumlah</td>
						<td>:</td>
